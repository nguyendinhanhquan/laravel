...
@section('content-header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Staff info</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            @foreach ($item as $item)
                    ...
                    <div class="card card-primary card-outline ">
                        <div class="card-body box-profile">
                            <div class="text-center wh-300 mx-auto">
                                <img class="profile-user-img img-fluid img-circle" src="{{ asset($item->avatar) }}"
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Birdthday: </b> <a class="float-right">
                                        @if ($item->birthday != null)
                                            {{ date_format(date_create($item->birthday), 'd-m-Y') }}
                                        @endif
                                    </a>
                                </li>
                            ...
                            <a href="{{ url('/edit/' . $item->id) }}"
                                class="btn btn-primary btn-block bg-color"><b>Edit</b></a>
                            @if ($item->id != 1)
                                <a href="{{ url('/user/active/' . $item->id) }}"
                                    class="btn btn-success btn-block "><b>Active</b></a>
                                <a href="{{ url('/user/disable/' . $item->id) }}"
                                    class="btn btn-danger btn-block "><b>Disable</b></a>
                            @endif
                ...
                <div class="card card-primary col-md-9">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">
                            @if ($item->start_job_at_company != null)
